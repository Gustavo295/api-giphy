...
import { Dimensions, FlatList, ImageBackground, Keyboard, StyleSheet, TouchableOpacity } from 'react-native';
  ...
  return (
    <ImageBackground source={require("../../assets/BG.png")} style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          return (
            <TouchableOpacity onPress={() => navigation.navigate("ScreenDetails", { item: item })}>
              <Image
                style={styles.image}
